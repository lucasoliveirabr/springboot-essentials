...
import academy.devdojo.springboot.util.*;
...
class AnimeControllerTest {
  ...
  @BeforeEach
  void setUp() {
    String date = DateCreator.createValidDate();
    PageImpl<Anime> animePage = new PageImpl<>(List.of(AnimeCreator.createValidAnime()));

    BDDMockito
        .when(dateUtilMock.formatLocalDateTimeToDatabaseStyle(ArgumentMatchers.any()))
        .thenReturn(date);
